...
\item \textbf{Passage-Level Grounding}: We conducted a 27-cell passage-support adjudication across representative scoring instances, verifying scored claims against verbatim text from the canonical PDFs to confirm that anti-guess rules prevent speculative inferences (Supplementary Table S7).
...
\begin{itemize}[leftmargin=*,noitemsep]
\item We performed a 10-figure manual expert validation against primary source PDFs, confirming 10/10 concordance on effect directions and glossary mappings.
