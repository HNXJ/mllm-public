...
def main():
    ...
    parser.add_argument('--glossary_path', default=str(REPO_ROOT / 'src/ontology/glossary/HPC/hpc-36-reference.md'))
    parser.add_argument('--instructions_path', default=str(REPO_ROOT / 'src/ontology/instructions/hpc_eval_prompt.md'))
    parser.add_argument('--mllm_input_path', default=os.environ.get('MLLM_INPUT_PATH', 'artifacts/data/inputs'))
    parser.add_argument('--mllm_output_path', default=os.environ.get('MLLM_OUTPUT_PATH', 'artifacts/data/outputs'))
