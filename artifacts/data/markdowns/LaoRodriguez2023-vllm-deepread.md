...
CO GN ITIV E N EURO SC IEN C E
Neuronal responses to omitted tones in the auditory
...
degree to which predictions are neuronally represented. Omission-sensitive neurons also responded to frequen-
...
1Cognitive and Auditory Neuroscience Laboratory (CANELAB), Institute of Neuro-
science of Castilla y León, University of Salamanca, Salamanca, Spain. 2Institute for
Biomedical Research of Salamanca (IBSAL), Salamanca, Spain. 3Computational
Neuroscience Lab, Department of Neurophysiology, Donders Centre of Neurosci-
ence, Nijmegen, Netherlands. 4Department of Basic Psychology, Psychobiology
and Methodology of Behavioral Sciences, University of Salamanca, Salamanca,
Spain. 5Department of Cell Biology and Pathology, University of Salamanca, Sala-
manca, Spain.
*Corresponding author. Email: msm@usal.es (M.S.M.); englitz@science.ru.nl (B.E.)
†These authors contributed equally to this work.
‡These authors contributed equally to this work.

SC I EN C E A D VA N CE S | RESE A RCH ARTI CL E

Lao-Rodríguez et al., Sci. Adv. 9, eabq8657 (2023)
14 June 2023
1 of 18

Downloaded from https://www.science.org at Vanderbilt University on February 09, 2026
...
> Figure caption (from PDF text): Fig. 1. Experimental setup and design for recording from the IC and AC. While stimulating with sequences of pure tones, neuronal activity was recorded using
microelectrodes in the urethane-anesthetized rats (AC and IC) as well as urethane-anesthetized and awake mice (AC). The long tone sequence consisted of a repeating
tone (standard probability: 90%) that was occasionally replaced by an omitted tone (average deviant probability: 10%). Traces correspond to actual recordings (from the IC
and AC of urethane-anesthetized rats, respectively). Red stars indicate neuronal responses during an omitted tone. SOA denotes the amount of time between the start of
one stimulus and the start of the following stimulus.
...
This figure, labeled "Fig. 1," illustrates the experimental setup and design for recording neuronal activity from two brain regions: the Inferior Colliculus (IC) and the Auditory Cortex (AC). The figure is structured into three main sections: two electrophysiological traces demonstrating neural responses, and a schematic diagram illustrating the auditory pathway.

### 1. Electrophysiological Traces (Top and Middle Panels)

The top two panels display time-series recordings of neuronal activity, presented as voltage traces. Both traces share a common vertical scale bar indicating amplitude: **$100 \mu V$**. A horizontal line labeled "Threshold" is present below the traces, indicating a baseline or detection level.

**Top Panel: Response to Stimuli Only**
*   This trace shows a continuous stream of neural activity corresponding to the presentation of stimuli.
*   The legend indicates three color-coded components:
    *   **Ascending auditory pathway:** Represented by a red upward arrow icon.
    *   **Nonlemniscal subdivisions:** Represented by a purple square icon.
    *   **Lemniscal subdivisions:** Represented by a green square icon.
*   The trace itself appears to be composed of overlapping activity, likely representing the combined response across these subdivisions.

**Middle Panel: Response to Omissions**
*   This trace is similar in format to the top panel but specifically highlights responses during stimulus omissions.
*   Red asterisks ($\text{*}$) are placed above the trace, indicating specific points in time where a neuronal response occurred during an omitted tone.
*   The caption clarifies that these traces correspond to recordings from the IC and AC of urethane-anesthetized rats.

### 2. Auditory Pathway Schematic (Right Side)

To the right of the traces is a schematic diagram illustrating the auditory pathway, showing anatomical structures and signal flow.

*   **Anatomical Structures:** The diagram depicts a cross-section of the brain, showing the **Cochlea** at the bottom right. The auditory pathway ascends through several labeled structures:
    *   The signal originates from the Cochlea.
    *   It proceeds towards the **Inferior Colliculus (IC)**, which is shown as a central structure.
    *   From the IC, pathways lead towards the **Auditory Cortex (AC)**, depicted as a cortical area.
*   **Signal Flow:** Arrows indicate the general flow of auditory information from the Cochlea up through the IC to the AC.
*   **Recording Points:** The schematic shows microelectrodes positioned near both the IC and AC, indicating where recordings are taken.

### 3. Stimulus Presentation Diagram (Bottom Panel)

The bottom panel illustrates the temporal sequence of stimulus presentation, defining the experimental paradigm.

*   **Timeline:** This is a linear timeline representing time progression.
*   **Stimulus Representation:** Small blue squares represent the presentation of a tone stimulus.
*   **Temporal Markers:**
    *   A segment labeled **"Silence period"** is shown before the sequence begins, with a duration specified as **$2.5-10 \text{ s}$**.
    *   The sequence of tones is followed by a gap labeled **"SOA"** (Stimulus Onset Asynchrony), with a duration specified as **$125-250 \text{ ms}$**.
*   **Contextual Annotations:** The caption clarifies that the sequence consists of a repeating tone (standard probability: 90%) occasionally replaced by an omitted tone (average deviant probability: 10%).

### Summary of Key Elements and Annotations

*   **Recording Locations:** Inferior Colliculus (IC) and Auditory Cortex (AC).
*   **Stimulation Paradigm:** Sequences of pure tones with controlled inter-stimulus intervals (SOA).
*   **Neural Markers:** Red stars ($\text{*}$) denote responses during omitted tones.
*   **Color Coding (Legend):** Red, Purple, and Green are used to categorize components of the auditory pathway response.
...
significance level of 0.05. We only checked for elevations in firing
...
> Figure description (generated): This figure is a single, comprehensive data table titled **"Table 1. Summary of firing rates."** It presents quantitative results comparing neural activity across different experimental conditions and groups.

### Overall Layout & Structure
The figure is structured as a detailed, multi-section data table. It uses rows to categorize different experimental conditions (e.g., Stimulus, Omission) and columns to represent the experimental groups: "AC anesthetized rat," "AC anesthetized mouse," and "AC awake mouse." The table is further subdivided into sections for descriptive statistics (Mean, Median) and statistical significance ($P$ values).

### Labels, Keys & Legends
**Title:** Table 1. Summary of firing rates.

**Column Headers (Groups):**
*   Firing rates (spks/s) - This is the primary unit header.
    *   AC anesthetized rat
    *   AC anesthetized mouse
    *   AC awake mouse

**Row Headers (Conditions):**
The rows are grouped logically:

**Section 1: Mean Firing Rates**
*   Stimulus
*   Omission
*   After-omission

**Section 2: Median Firing Rates**
*   Stimulus
*   Omission
*   After-omission

**Section 3: $P$ values (Statistical Comparisons)**
*   Stimulus/pre-omission
*   Omission/pre-omission
*   After-omission/pre-omission
*   Omission/stimulus
*   Stimulus/after-omission
*   Omission/after-omission

### Data Trends & Details (Specific Values)

**Mean Firing Rates (spks/s):**
*   **Stimulus:** 1.0963 (Rat), 0.4046 (Mouse, Anesthetized), 2.0372 (Mouse, Awake)
*   **Omission:** 1.1347 (Rat), 1.0728 (Mouse, Anesthetized), 5.3385 (Mouse, Awake)
*   **After-omission:** 2.9421 (Rat), 3.1175 (Mouse, Anesthetized), 2.0246 (Mouse, Awake)

**Median Firing Rates (spks/s):**
*   **Stimulus:** 0.8614 (Rat), 0.3840 (Mouse, Anesthetized), 1.4255 (Mouse, Awake)
*   **Omission:** 1.087 (Rat), 0.9116 (Mouse, Anesthetized), 3.2464 (Mouse, Awake)
*   **After-omission:** 1.1592 (Rat), 1.8439 (Mouse, Anesthetized), 1.8081 (Mouse, Awake)

**$P$ values:**
*   **Stimulus/pre-omission:** 0.0002 (Rat), <0.0001 (Mouse, Anesthetized), <0.0001 (Mouse, Awake)
*   **Omission/pre-omission:** 0.0001 (Rat), <0.0001 (Mouse, Anesthetized), <0.0001 (Mouse, Awake)
*   **After-omission/pre-omission:** 0.0001 (Rat), <0.0001 (Mouse, Anesthetized), <0.0001 (Mouse, Awake)
*   **Omission/stimulus:** 0.5765 (Rat), 0.0670 (Mouse, Anesthetized), <0.0001 (Mouse, Awake)
*   **Stimulus/after-omission:** 0.0384 (Rat), <0.0001 (Mouse, Anesthetized), 0.2756 (Mouse, Awake)
*   **Omission/after-omission:** 0.2769 (Rat), 0.0016 (Mouse, Anesthetized), <0.0001 (Mouse, Awake)

In summary, the table systematically compares mean and median firing rates across three groups (Rat, Anesthetized Mouse, Awake Mouse) for three conditions (Stimulus, Omission, After-omission), followed by a set of statistical comparisons ($P$ values) between these conditions.
...
relative to stimulus responses (P < 0.001; Fig. 3C; cf. Table 1
for details).
...
Neurons from the three recorded conditions are shown in the different columns (anesthetized rat, anesthetized mouse, and awake mouse; from left to right, respectively).
...
> Figure caption (from PDF text): Fig. 2. Neurons in the AC show responses to the omission of a predictable sound. (A) Representative examples of omission responses in individual AC neurons.
Neurons from the three recorded conditions are shown in the different columns (anesthetized rat, anesthetized mouse, and awake mouse; from left to right, respectively).
Firing rates (spikes per second) and time (ms) are represented in vertical and horizontal axes. The duration of the stimuli and omitted tones (75 ms) is represented by
vertical gray-shaded and white continuous line boxes, respectively. The responses have been computed as centered on the omitted tone whose response is occurring
during the white vertical reference box. The red traces indicate responses during the omission analysis window. The preomission activity is also depicted as reference
(gray horizontal line). Shaded areas indicate SEM. (B) Grand average of the responses of all the omission-sensitive neurons, per recorded condition, indicating the number
of neurons included.
> Figure description (generated): ## Figure Description: Neurons in the AC Showing Responses to Omission of a Predictable Sound

This figure, labeled as Figure 2, presents data illustrating the responses of neurons in the Auditory Cortex (AC) to the omission of a predictable sound. The figure is divided into two main panels, **Panel A** and **Panel B**, each containing three comparative plots.

### Overall Layout & Structure
The figure is structured into two rows: Panel A and Panel B. Both panels display three distinct columns, representing data collected from different experimental conditions: "Anesthetized rat," "Anesthetized mouse," and "Awake mouse."

*   **Panel A:** Shows representative examples of responses from individual AC neurons.
*   **Panel B:** Shows the grand average response across all omission-sensitive neurons for each condition.

### Visual Components & Symbols (General)
The plots are time-series graphs where the y-axis represents **Firing rate (spks/s)** and the x-axis represents **Time (ms)**.

*   **Shaded Areas:** Indicate Standard Error of the Mean (SEM).
*   **Vertical Gray-shaded Boxes:** Represent the duration of the stimuli/tones (75 ms).
*   **White Continuous Line Boxes:** Represent the duration of the omitted tones.

### Panel A: Individual Neuron Responses
Panel A displays three separate plots, one for each condition (Anesthetized rat, Anesthetized mouse, Awake mouse).

*   **Y-Axis:** Labeled "Firing rate (spks/s)," ranging from 0 to 20 spikes/s in the rat and mouse plots, and up to 40 spikes/s in the awake mouse plot.
*   **X-Axis:** Labeled "Time (ms)," ranging from 0 to approximately 300 ms.
*   **Traces:** The red traces represent the responses during the omission analysis window.
*   **Reference Line:** A horizontal gray line is present, representing preomission activity (as per the caption).

**Specific Observations in Panel A:**
*   **Anesthetized rat:** Shows low firing rates, with a slight increase during the stimulus/omission windows.
*   **Anesthetized mouse:** Shows a more pronounced response pattern compared to the rat, with activity peaking around 250 ms.
*   **Awake mouse:** Exhibits the highest firing rates, with clear peaks occurring during and immediately following the stimulus/omission windows.

### Panel B: Neuronal Population Average
Panel B displays three corresponding plots, showing the grand average response for each condition.

*   **Y-Axis:** Labeled "Firing rate (spks/s)," with scales similar to Panel A.
*   **X-Axis:** Labeled "Time (ms)," ranging from 0 to approximately 300 ms.
*   **Annotations:** Each plot includes an annotation indicating the number of neurons included in the average: $n=15$ (Anesthetized rat), $n=76$ (Anesthetized mouse), and $n=140$ (Awake mouse).
*   **Traces:** The traces represent the grand average response.

### Legend and Key Interpretation (Based on Caption)
The legend provided below the plots clarifies the meaning of different response types:

*   **Red Line:** Omission response
*   **Blue Line:** Stimulus response
*   **Gray Horizontal Line:** Preomission activity

The caption further specifies that the responses are computed centered on the omitted tone, and the red traces specifically indicate responses occurring during the omission analysis window.

### Summary of Data Trends
The figure visually compares how individual neurons (Panel A) and the population average (Panel B) respond to sound omission across three states: anesthetized rat, anesthetized mouse, and awake mouse. The data suggests that the magnitude of the omission response increases significantly from the anesthetized rat to the awake mouse condition, both in individual neurons and across the population average.
...
sound-evoked activity over the analysis window. Second, the neural
...
the awake compared with the anesthetized state in the mouse. While
...
Similarly, the white circles indicate the median and the white triangles show the 95% confidence interval for the median. Evoked firing rates have been baseline-corrected,
...
> Figure caption (from PDF text): Fig. 3. The prevalence and strength of omission responses increase under awake condition. Firing rates of omission-sensitive neurons in the AC of the anesthetized
rat (A), anesthetized mouse (B), and awake mouse (C). Sound-, omission-, and after-omission–evoked activities are represented by blue, red, and purple violin plots,
respectively. In this and similar violin plots, the horizontal solid lines indicate the mean of the distribution, while the inner gray box indicates the interquartile range.
Similarly, the white circles indicate the median and the white triangles show the 95% confidence interval for the median. Evoked firing rates have been baseline-corrected,
relative to preomission activity. Asterisks directly over the violin plots indicate that the distribution is statistically different from 0 (Wilcoxon test with Holm-Bonferroni
correction; see Table 1). Asterisks over horizontal lines indicate significantly different distributions (Wilcoxon test with Holm-Bonferroni correction; see Table 1). *P < 0.05,
**P < 0.01, and ***P < 0.001.
> Figure description (generated): ## Figure Description: Firing Rates of Omission-Sensitive Neurons

This figure, labeled "Fig. 3," presents a comparison of the firing rates of omission-sensitive neurons across three experimental conditions: an anesthetized rat, an anesthetized mouse, and an awake mouse. The data is visualized using violin plots across three distinct panels (A, B, and C).

### 1. Overall Layout & Structure
The figure is organized into three vertical panels: Panel A, Panel B, and Panel C. Each panel represents a different experimental condition (Anesthetized Rat, Anesthetized Mouse, Awake Mouse). Within each panel, there are three distinct distributions plotted along the y-axis, corresponding to different types of evoked activity.

### 2. Visual Components & Symbols
The primary visualization tool is the **violin plot**, which displays the distribution of firing rates.

*   **Y-Axis:** Labeled "Firing rate (spks/s)," ranging from -20 to 40.
*   **X-Axis (Implicit):** The three distributions within each panel correspond to different types of evoked activity, differentiated by color and legend.
*   **Color Coding & Activity Types (from Legend):**
    *   **Blue:** Represents the "Stimulus response."
    *   **Red:** Represents the "Omission response."
    *   **Purple:** Represents the "After-omission response."
*   **Plot Elements (as per Caption):**
    *   The **violin shape** itself represents the distribution of firing rates.
    *   A **horizontal solid line** within each violin plot indicates the mean of the distribution.
    *   An **inner gray box** within each violin plot indicates the interquartile range (IQR).
    *   A **white circle** marks the median of the distribution.
    *   A **white triangle** indicates the 95% confidence interval for the median.
*   **Statistical Annotations:** Asterisks ($\text{*}$, $\text{**}$, $\text{***}$) are used above the plots to denote statistical significance:
    *   Asterisks directly over a violin plot indicate that the distribution is statistically different from 0 (Wilcoxon test with Holm-Bonferroni correction).
    *   Asterisks over horizontal lines indicate significantly different distributions (Wilcoxon test with Holm-Bonferroni correction).
    *   Significance levels are defined in the caption: $\text{*P} < 0.05$, $\text{**P} < 0.01$, and $\text{***P} < 0.001$.

### 3. Panel-Specific Details and Data Trends

**Panel A: AC anesthetized rat**
This panel shows the distributions for the rat. Statistical significance markers are present above the plots, indicating comparisons between conditions or against a baseline (implied by the caption).

**Panel B: AC anesthetized mouse**
This panel shows the distributions for the anesthetized mouse. Several sets of asterisks are present, indicating significant differences between the plotted distributions (e.g., comparing Stimulus response vs. Omission response, or against zero).

**Panel C: AC awake mouse**
This panel shows the distributions for the awake mouse. This panel exhibits the most pronounced differences, with multiple sets of $\text{***}$ annotations indicating highly significant statistical differences between the distributions.

### 4. Contextual Caption Integration
The caption clarifies that:
1.  The figure illustrates "The prevalence and strength of omission responses increase under awake condition."
2.  The neurons studied are "omission-sensitive neurons in the AC" (Auditory Cortex).
3.  The firing rates are "baseline-corrected, relative to preomission activity."

In summary, the figure uses violin plots across three animal models (Rat, Anesthetized Mouse, Awake Mouse) to compare the mean and distribution of firing rates for three distinct auditory events (Stimulus, Omission, After-omission), demonstrating a trend toward increased omission response strength in the awake state.
...
could differ from the stimulus response (forward response) as
...
> Figure caption (from PDF text): Fig. 4. Responses to omission become larger than stimulus responses under the awake condition. Distribution of iOmi between the recorded conditions. (A) iOmi
for omission-sensitive neurons show progressively increasing values, from negative under the rat anesthetized condition, to positive values in the mouse preparations,
being highest under the awake condition. Positive iOmi values indicate that the neuron responds with higher firing rates to the omission than to the stimulus, while
negative values indicate the opposite. (B) Comparison of omission-sensitive (red) with omission-insensitive (blue) neurons shows increasing omission selectivity toward
AC and further in the awake state. This is indicated by a larger separation between the curves, particularly for values >0, indicating greater responses to omissions
than stimuli.
> Figure description (generated): ## Figure Description: Responses to Omission (iOmi)

This figure, labeled as **Fig. 4**, is divided into two main panels, **A** and **B**, both presenting data related to the omission index ($\text{iOmi}$) across different experimental conditions.

---

### Panel A: Omission Index ($\text{iOmi}$) Distributions (Histograms)

Panel A consists of three side-by-side histograms, each representing the distribution of $\text{iOmi}$ values under a specific experimental condition.

**Structure:**
The panel is organized horizontally into three distinct subplots:
1. **AC anesthetized rat**
2. **AC anesthetized mouse**
3. **AC awake mouse**

**Axes and Labels:**
*   **Y-axis (Vertical):** Labeled "**n cells**," representing the number of neurons exhibiting a certain $\text{iOmi}$ value. The scale ranges from 0 to 30.
*   **X-axis (Horizontal):** Labeled "**iOmi**," representing the omission index. The scale ranges from -1 to 1 in all three plots.

**Data Trends and Details:**
*   **AC anesthetized rat:** The distribution is centered near 0. A vertical dashed red line indicates the mean, which is annotated as **Mean = -0.089**. The histogram shows a small number of cells clustered near 0, with the majority having very low counts.
*   **AC anesthetized mouse:** The distribution is clearly shifted towards positive values, centered around 0. A vertical dashed red line indicates the mean, annotated as **Mean = -0.006**. The histogram shows a higher concentration of cells compared to the rat condition, clustered around 0.
*   **AC awake mouse:** The distribution is strongly shifted towards positive values, centered around a positive mean. A vertical dashed red line indicates the mean, annotated as **Mean = 0.055**. This distribution shows a clear peak at positive $\text{iOmi}$ values.

---

### Panel B: Cumulative Distribution (Line Plots)

Panel B presents two comparative line plots, showing the cumulative distribution of $\text{iOmi}$ for different neuron types across conditions.

**Structure:**
The panel is organized horizontally into three side-by-side plots, mirroring the conditions in Panel A:
1. **AC anesthetized rat**
2. **AC anesthetized mouse**
3. **AC awake mouse**

**Axes and Labels:**
*   **Y-axis (Vertical):** Labeled "**Cumulative distrib.**," ranging from 0 to 1.
*   **X-axis (Horizontal):** Labeled "**Omission-stimulus FR (spks/s)**," ranging from -10 to 40 in the first two plots, and -40 to 40 in the third plot.

**Legend/Color Coding:**
Two lines are present in each subplot, distinguished by color:
*   **Red Line:** Labeled "**Omission-sensitive**" in the legend.
*   **Blue Line:** Labeled "**Omission-insensitive**" in the legend.

**Data Trends and Details:**
*   **AC anesthetized rat:** The red (Omission-sensitive) and blue (Omission-insensitive) curves are very close together, indicating minimal separation. A p-value annotation is present: **P = 0.028**.
*   **AC anesthetized mouse:** The red and blue curves begin to separate, with the red curve rising slightly faster than the blue curve. A p-value annotation is present: **P = 0.016**.
*   **AC awake mouse:** The separation between the red and blue curves is most pronounced here. The red curve shows a significantly higher cumulative distribution at positive $\text{iOmi}$ values compared to the blue curve. A p-value annotation is present: **P = $1.7 \times 10^{-8}$**.

---
*Note on Caption Integration:* The caption explains that positive $\text{iOmi}$ indicates a higher firing rate to omission than stimulus, while negative values indicate the opposite. Panel A visually demonstrates this shift from negative (rat) to positive (awake mouse). Panel B illustrates the increasing "omission selectivity" (separation between red and blue curves) as conditions progress from rat $\rightarrow$ mouse $\rightarrow$ awake mouse.
...
properties in the AC show that omission-sensitive neurons can also
...
Fig. 5. Comparison of response latencies for omission and stimulus responses. Distribution of response peak latencies (ms) of omission-sensitive neurons in the AC of
...
> Figure caption (from PDF text): Fig. 5. Comparison of response latencies for omission and stimulus responses. Distribution of response peak latencies (ms) of omission-sensitive neurons in the AC of
the anesthetized rat (A), anesthetized mouse (B), and awake mouse (C). The blue, red, and purple violin plots depict the distribution of the sound stimuli, omission, and
after-omission latencies (see Fig. 3 for the meaning of the violin plot symbols). Asterisks denote statistical significance between stimuli and omission latencies (***P <
0.001; paired Wilcoxon with Holm-Bonferroni correction; see Table 2).
> Figure description (generated): ## Figure 5 Description: Comparison of Response Latencies

This figure, labeled "Fig. 5," presents a comparison of response latencies for omission and stimulus responses across three experimental conditions: an anesthetized rat, an anesthetized mouse, and an awake mouse. The data is visualized using violin plots to show the distribution of response peak latencies in omission-sensitive neurons within the Auditory Cortex (AC).

### 1. Overall Layout & Structure
The figure is organized into three distinct vertical panels, labeled A, B, and C, arranged horizontally across the top. Each panel represents a different experimental condition:
*   **Panel A:** AC anesthetized rat
*   **Panel B:** AC anesthetized mouse
*   **Panel C:** AC awake mouse

Within each panel, there are three distinct violin plots stacked vertically, corresponding to different types of responses.

### 2. Visual Components & Symbols
**Violin Plots:** The primary data visualization tool is the violin plot, which displays the probability density of the response latencies.
*   **Color Coding:** Three distinct colors are used to represent different types of responses:
    *   **Blue:** Represents the "Stimulus response."
    *   **Red:** Represents the "Omission response."
    *   **Purple:** Represents the "After-omission response."
*   **Internal Markers:** Within each violin plot, there are internal markers indicating central tendency:
    *   A horizontal line segment (likely representing the median or mean) is visible within each distribution.
    *   A small triangle marker (▲) is present near the center of each violin plot, likely indicating a specific measure like the mean or median.

**Statistical Annotations:**
*   In Panel C (AC awake mouse), there are asterisks ($\text{***}$) placed above the plots, indicating statistical significance. These annotations span across comparisons between different response types within Panel C.

### 3. Labels, Keys & Legends
**Y-Axis Label:** The vertical axis for all plots is labeled **"Latency (ms)"**, ranging from 0 to over 125 ms.
**X-Axis Labels (Implicit):** The x-axis is implicitly defined by the three response types represented by the color coding, as detailed in the legend.

**Legend:** A key provided below the plots clarifies the color coding:
*   $\text{Red line/plot}$: Omission response
*   $\text{Blue line/plot}$: Stimulus response
*   $\text{Purple line/plot}$: After-omission response

**Statistical Notation:** The caption specifies that asterisks denote statistical significance: $\text{***P < 0.001}$; paired Wilcoxon with Holm-Bonferroni correction; see Table 2}$.

### 4. Data Trends & Details
**Panel A (Anesthetized Rat):** Shows three distributions (Blue, Red, Purple). The plots appear relatively narrow compared to the mouse panels.
**Panel B (Anesthetized Mouse):** Shows three distributions, generally wider than Panel A.
**Panel C (Awake Mouse):** This panel shows the most pronounced differences, indicated by the statistical markers.
*   The **Blue (Stimulus response)** plot is positioned lower on the latency scale compared to the Red and Purple plots.
*   The **Red (Omission response)** and **Purple (After-omission response)** plots appear to have higher median latencies than the blue plot.
*   The $\text{***}$ annotations suggest significant differences exist between the latency distributions in this awake condition.

### 5. Contextual Caption Integration
The caption confirms that the figure compares "response peak latencies (ms) of omission-sensitive neurons in the AC." It further clarifies that the blue, red, and purple violin plots correspond to the "sound stimuli," "omission," and "after-omission latencies," respectively. The statistical significance markers ($\text{***}$) specifically denote differences between "stimuli and omission latencies."

> Figure caption (from PDF text): Fig. 5. Comparison of response latencies for omission and stimulus responses. Distribution of response peak latencies (ms) of omission-sensitive neurons in the AC of
the anesthetized rat (A), anesthetized mouse (B), and awake mouse (C). The blue, red, and purple violin plots depict the distribution of the sound stimuli, omission, and
after-omission latencies (see Fig. 3 for the meaning of the violin plot symbols). Asterisks denote statistical significance between stimuli and omission latencies (***P <
0.001; paired Wilcoxon with Holm-Bonferroni correction; see Table 2).
> Figure description (generated): The provided image is **Table 2: Summary of responses latencies**, which presents quantitative summary statistics regarding response latencies across different experimental conditions. It is a tabular data presentation, not a graphical plot like the one described in the associated caption (Fig. 5).

Here is an exhaustive description of the table's structure and contents:

### 1. Overall Layout & Structure
The content is organized into a single, comprehensive data table with multiple columns and rows detailing mean and median values for different response latency measurements.

### 2. Column Structure
The table is structured with a primary row header defining the type of measurement, and subsequent columns differentiating the experimental groups:
*   **Response latency (ms)**: This serves as the primary row header defining the measured variable.
*   **AC anesthetized rat**: Data column for responses recorded in the Anteroventral Cortex (AC) of an anesthetized rat.
*   **AC anesthetized mouse**: Data column for responses recorded in the AC of an anesthetized mouse.
*   **AC awake mouse**: Data column for responses recorded in the AC of an awake mouse.

### 3. Row Structure and Data Categories
The rows are grouped by the type of statistical summary (Mean or Median) and the specific latency measurement:

**A. Mean Latencies:**
*   **Stimulus**: The mean response latency following the initial stimulus.
*   **Omission**: The mean response latency during an omission event.
*   **After-omission**: The mean response latency following the omission period.

**B. Median Latencies:**
*   **Stimulus**: The median response latency following the initial stimulus.
*   **Omission**: The median response latency during an omission event.
*   **After-omission**: The median response latency following the omission period.

**C. P values:**
This section compares statistical significance between different latency measurements:
*   **Stimulus/omission**: P-value comparing Stimulus vs. Omission latencies.
*   **Stimulus/after-omission**: P-value comparing Stimulus vs. After-omission latencies.
*   **Omission/after-omission**: P-value comparing Omission vs. After-omission latencies.

### 4. Data Trends and Specific Values
The table provides precise numerical data for each category:

**Mean Latencies (ms):**
*   **Stimulus:** 42.8333 (Rat), 50.4474 (Mouse, Anesthetized), 36.5929 (Mouse, Awake)
*   **Omission:** 42.5 (Rat), 56.3289 (Mouse, Anesthetized), 57.8214 (Mouse, Awake)
*   **After-omission:** 61.9 (Rat), 47.1842 (Mouse, Anesthetized), 40.5 (Mouse, Awake)

**Median Latencies (ms):**
*   **Stimulus:** 36.5 (Rat), 41 (Mouse, Anesthetized), 17.5 (Mouse, Awake)
*   **Omission:** 35.5 (Rat), 50.5 (Mouse, Anesthetized), 54.5 (Mouse, Awake)
*   **After-omission:** 78.5 (Rat), 38.5 (Mouse, Anesthetized), 26.5 (Mouse, Awake)

**P values:**
*   **Stimulus/omission:** 0.8904 (Rat), 0.8904 (Mouse, Anesthetized), <0.0001 (Mouse, Awake)
*   **Stimulus/after-omission:** 0.5830 (Rat), 0.5830 (Mouse, Anesthetized), 0.3066 (Mouse, Awake)
*   **Omission/after-omission:** 0.4052 (Rat), 0.4052 (Mouse, Anesthetized), 0.0001 (Mouse, Awake)

*(Note: The associated caption refers to Figure 5 and violin plots, which are not present in the provided image; this description is strictly limited to Table 2.)*
...
conditions. A dependence on the number of preceding standards is
...
> Figure caption (from PDF text): Fig. 6. Omission-sensitive neurons differentiate their response from deviants in the awake state. (A) In the AC in the anesthetized mouse, omission-sensitive
neurons show a strong response to deviants (orange; left), which substantially exceed the omission (red) and standard stimulus (blue) responses [P = 0.00018 and P
= 1.4 × 10−9, Wilcoxon signed-rank test (one-sided) between deviant responses relative to omission or standard responses; n = 76]. The relative responses of omission-
sensitive (red) and omission-insensitive (blue) neurons to omissions and deviant stimuli are statistically indistinguishable (middle), indicated by the overlapping cumu-
lative distributions of difference between omission and deviant responses (right column; P = 0.15, Wilcoxon rank sum test between the two populations on omission-
...
deviant response (middle; red dots above diagonal). In the awake state, omission-sensitive neurons show a clear and significant separation in the difference between
omission and deviant responses (P = 0.0017).
> Figure description (generated): ## Figure 6 Description

This figure, titled "Omission-sensitive neurons differentiate their response from deviants in the awake state," is divided into two main panels, **Panel A** and **Panel B**, each presenting a set of three related plots comparing neural responses in different states (anesthetized vs. awake).

---

### Panel A: Anesthetized Mouse (AC)

Panel A displays three plots related to the responses in an anesthetized mouse.

**1. Left Plot (Firing Rate):**
*   **Type:** Line plot showing firing rate over time.
*   **Y-axis Label:** "Firing rate (spks/s)" ranging from 0 to 25.
*   **X-axis Label:** "Time (ms)" ranging from -25 to 125.
*   **Data Representation:** Multiple colored lines represent different conditions:
    *   Orange line (labeled "Deviant"): Shows a clear, transient increase in firing rate peaking around 75 ms.
    *   Red line (labeled "Omission"): Shows a lower, transient increase in firing rate.
    *   Blue line (labeled "Stimulus"): Shows a baseline or minimal response.
*   **Annotation:** Shaded areas beneath the lines indicate one Standard Error of the Mean (SEM).
*   **Legend:** Indicates colors for "Omission" (Red), "Deviant" (Orange), and "Stimulus" (Blue).

**2. Middle Plot (Omission FR vs. Deviant FR):**
*   **Type:** Scatter plot comparing firing rates.
*   **Y-axis Label:** "Omission FR (spks/s)" ranging from 0 to 40.
*   **X-axis Label:** "Deviant FR (spks/s)" ranging from 0 to 40.
*   **Data Points:** Individual data points are plotted, colored according to cell type:
    *   Red dots (labeled "Omission-sensitive"): Represent cells sensitive to omissions.
    *   Blue dots (labeled "Omission-insensitive"): Represent cells insensitive to omissions.
*   **Annotation:** A horizontal dashed line is present near $FR=0$.

**3. Right Plot (Cumulative Distribution):**
*   **Type:** Cumulative distribution function plot.
*   **Y-axis Label:** "Cumulative distrib." ranging from -1 to 1.
*   **X-axis Label:** "Omission-deviant FR (spks/s)" ranging from -40 to 40.
*   **Data Curves:** Two curves are plotted:
    *   Red line (labeled "Omission-sensitive"): Represents the distribution for omission-sensitive neurons.
    *   Blue line (labeled "Omission-insensitive"): Represents the distribution for omission-insensitive neurons.
*   **Annotation:** A statistical result is noted: "$P = 0.15$".

---

### Panel B: Awake Mouse (AC)

Panel B displays three plots related to the responses in an awake mouse. The structure mirrors Panel A, but the data reflects the awake state.

**1. Left Plot (Firing Rate):**
*   **Type:** Line plot showing firing rate over time.
*   **Y-axis Label:** "Firing rate (spks/s)" ranging from 0 to 70.
*   **X-axis Label:** "Time (ms)" ranging from -25 to 125.
*   **Data Representation:** Multiple colored lines represent different conditions:
    *   Orange line (labeled "Deviant"): Shows a clear, sustained increase in firing rate.
    *   Red line (labeled "Omission"): Shows a response that is comparable in magnitude to the deviant response.
    *   Blue line (labeled "Stimulus"): Shows a baseline or minimal response.
*   **Legend:** Indicates colors for "Omission" (Red), "Deviant" (Orange), and "Stimulus" (Blue).
...
*   **Data Points:** Individual data points are plotted, colored according to cell type:
    *   Red dots (labeled "Omission-sensitive"): Represent cells sensitive to omissions.
    *   Blue dots (labeled "Omission-insensitive"): Represent cells insensitive to omissions.
*   **Annotation:** The caption notes that many red dots are above the diagonal line (implying Omission FR > Deviant FR).
...
*   **X-axis Label:** "Omission-deviant FR (spks/s)" ranging from -40 to 40.
*   **Data Curves:** Two curves are plotted:
    *   Red line (labeled "Omission-sensitive").
    *   Blue line (labeled "Omission-insensitive").
*   **Annotation:** A statistical result is noted: "$P = 0.0017$".
...
Fig. 7. Omission response progression depends on brain state. (A) Responses of the omission-sensitive cells to the standard stimulus (blue) adapt in both the anes-
...
> Figure caption (from PDF text): Fig. 7. Omission response progression depends on brain state. (A) Responses of the omission-sensitive cells to the standard stimulus (blue) adapt in both the anes-
thetized (left) and awake (right) state. Adaptation occurs more rapidly in the anesthetized state, reaching baseline already after ~1 s, while in the awake state, two time
scales of adaptation are apparent, one very fast (one to two stimuli, i.e., ~125 to 250 ms) and the second with a time constant of ~5 s. The omission response stays rather
constant over the entire period under both conditions but is consistently larger in the awake case (P = 1.2 × 10−22, Wilcoxon signed rank test between awake and
anesthetized). (B) The index of omission sensitivity in relation to the standard responses, iOmi, consequently increases over time in the awake case (r = 0.38, p = 1.2
...
quickly, within two stimuli under anesthesia and just one stimulus in the awake (see inset for 20-ms analysis window; P values based on Kruskal-Wallis ANOVA). Using our
standard analysis window (5 to 120 ms), the effect is also significant, but less pronounced, because of the brevity of the response (see Fig. 2B, right).
> Figure description (generated): ## Figure 7 Description: Omission Response Progression Depends on Brain State

This figure, labeled "Fig. 7," presents a multi-panel comparison of neural responses in an anesthetized versus an awake mouse, investigating how the omission response evolves across different brain states. The figure is divided into four main panels: A, B, C, and D.

---

### Panel A: Firing Rate Over Time (Time Course Analysis)

Panel A consists of two side-by-side line plots comparing the firing rate in both states.

**Left Plot (Anesthetized Mouse):**
*   **Title/Context:** Implied to be the anesthetized state.
*   **Y-axis Label:** "Firing rate (norm)" (ranging from approximately 0.5 to 2.0).
*   **X-axis Label:** "Time (s)" (ranging from 0 to 50 seconds).
*   **Data Representation:** Two lines are plotted: "Omission" (red line) and "Stimulus" (blue line).
*   **Legend:** Indicates the color coding for "Omission" and "Stimulus."
*   **Annotation:** $n = 76$ is noted in the upper right corner, likely indicating the number of trials or cells analyzed.
*   **Trend:** Both lines show fluctuations, but the red line (Omission) appears to adapt relatively quickly towards a lower baseline compared to the blue line (Stimulus).

**Right Plot (Awake Mouse):**
*   **Title/Context:** Implied to be the awake state.
*   **Y-axis Label:** "Firing rate (norm)" (ranging from approximately 0.5 to 2.0).
*   **X-axis Label:** "Time (s)" (ranging from 0 to 50 seconds).
*   **Data Representation:** Two lines are plotted: "Omission" (red line) and "Stimulus" (blue line).
*   **Legend:** Indicates the color coding for "Omission" and "Stimulus."
*   **Annotation:** $n = 140$ is noted in the upper right corner.
*   **Trend:** Both lines show more sustained fluctuations compared to the anesthetized state, with distinct patterns visible over time.

---

### Panel B: Index of Omission Sensitivity ($iOmi$) Correlation

Panel B also consists of two side-by-side plots showing the correlation coefficient ($r$) over time.

**Left Plot (Anesthetized Mouse):**
*   **Y-axis Label:** Implied to be related to the index of omission sensitivity.
*   **X-axis Label:** "Time (s)" (ranging from 0 to 50 seconds).
*   **Data Representation:** A fluctuating line plot showing the index over time.
*   **Annotation:** $r = 0.1, P = 0.035$ is noted in the upper right corner, indicating a weak correlation with borderline significance.

**Right Plot (Awake Mouse):**
*   **Y-axis Label:** Implied to be related to the index of omission sensitivity.
*   **X-axis Label:** "Time (s)" (ranging from 0 to 50 seconds).
*   **Data Representation:** A fluctuating line plot showing the index over time.
*   **Annotation:** $r = 0.38, P = 1.2 \times 10^{-16}$ is noted in the upper right corner, indicating a stronger correlation with high significance.

---

### Panel C: Omission Response Dependence on Preceding Standards

Panel C displays two line graphs illustrating the omission response as a function of preceding standards, one for each brain state.

**Left Plot (Anesthetized State):**
*   **Y-axis Label:** "Response (norm)" (ranging from approximately 0.8 to 1.4).
*   **X-axis Label:** "Preceding standards" (discrete values: 2, 4, 6, 8, 10, 12, 14, 16).
*   **Data Representation:** Two lines are shown: "Omission" (red line) and "After omission" (gray/lighter line).
*   **Annotations:** Statistical results are provided: $P = 0.02$ (associated with the main effect) and $P = 0.39$.
*   **Trend:** The "Omission" response shows a slight increasing trend across the preceding standards, while the "After omission" response remains relatively stable.

**Right Plot (Awake State):**
*   **Y-axis Label:** "Response (norm)" (ranging from approximately 0.8 to 1.4).
*   **X-axis Label:** "Preceding standards" (discrete values: 2, 4, 6, 8, 10, 12, 14, 16).
*   **Data Representation:** Two lines are shown: "Omission" (red line) and "After omission" (gray/lighter line).
*   **Annotations:** Statistical results are provided: $P = 0.94$ and $P = 0.00074$.
*   **Trend:** The "Omission" response starts at a high level and appears relatively flat across the preceding standards. The "After omission" response shows a clear decay trend towards a plateau level.

---

### Panel D: Stimulus Response Following Omission (Post-Omission Decay)

Panel D presents two plots examining the response to a standard stimulus immediately following an omission event.

**Left Plot (Anesthetized State):**
*   **Y-axis Label:** "Stimulus response (norm)" (ranging from approximately 0.8 to 1.4).
*   **X-axis Label:** "Position after omission" (discrete values: 2, 4, 6, 8, 10, 12, 14, 16).
*   **Data Representation:** A single line plot showing the response decay.
*   **Annotation:** $P = 3.6 \times 10^{-16}$ is noted, indicating a significant decay.
*   **Inset:** A small inset graph is present, labeled for "20-ms analysis window," showing a rapid decay.

**Right Plot (Awake State):**
*   **Y-axis Label:** "Stimulus response (norm)" (ranging from approximately 0.8 to 1.4).
*   **X-axis Label:** "Position after omission" (discrete values: 2, 4, 6, 8, 10, 12, 14, 16).
*   **Data Representation:** A single line plot showing the response decay.
*   **Annotation:** $P = 1.1 \times 10^{-15}$ and $P = 8.6 \times 10^{-11}$ are noted, indicating significant decay.
*   **Contextual Note:** The caption mentions that the response decayed quickly in the awake state, specifically within one stimulus using a 20-ms window.
...
additional research with higher-density probes will be required to
fully address this question.

Last, we investigated the location of omission-sensitive neurons
in subfields of the AC. Location data were only available in the rat, as
...
> Figure caption (from PDF text): Fig. 8. Distribution of omission-sensitive neurons in the AC layers. (A) Anesthetized rat, (B) anesthetized mouse, and (C) awake mouse. Horizontal dashed lines
indicate the boundaries between supragranular, granular, and infragranular layers. While the fraction of omission-sensitive neurons (burgundy bars) relative to the
total sample (gray bars) is low in supragranular layers in anesthetized rats, for awake mice, there is a tendency toward a higher proportion of omission-sensitive
neurons in the supragranular layers. Note that the depth AC is 1400 μm thick in mice because of the oblique trajectory of the recording electrodes to the pial
surface, while in rat, it is 1200 μm thick because of the orthogonal trajectory.
> Figure description (generated): ## Figure Description: Distribution of Omission-Sensitive Neurons in AC Layers

This figure, labeled "Fig. 8," presents a comparative visualization of the distribution of omission-sensitive neurons across different layers within the Amygdala Cortex (AC) for three experimental conditions: an anesthetized rat, an anesthetized mouse, and an awake mouse. The data is presented in three distinct panels (A, B, and C), utilizing bar charts to represent neuron counts.

### 1. Overall Layout & Structure
The figure is organized into three side-by-side panels: Panel A, Panel B, and Panel C. Each panel displays a bar chart comparing the total number of neurons sampled versus the subset identified as omission-sensitive, stratified by depth within the AC.

### 2. Visual Components & Symbols
*   **Bar Charts:** Each panel contains a series of horizontal bars corresponding to different depth ranges.
    *   **Gray Bars (Sample):** Represent the total number of neurons sampled at a given depth.
    *   **Burgundy/Maroon Bars (Omission-sensitive):** Represent the count of neurons identified as omission-sensitive within that depth range.
*   **Depth Axis (Y-axis):** The vertical axis represents the **Depth ($\mu$m)**, ranging from 0 $\mu$m down to 1400 $\mu$m.
*   **Neuron Count Axis (X-axis):** The horizontal axis represents the **Neurons**, with tick marks labeled at 0, 10, 25, 35, and 50 (though the scale varies slightly between panels).
*   **Layer Boundaries:** Horizontal dashed lines are used across all three panels to delineate the anatomical layers:
    *   A line separating **Supragranular** and **Granular** layers.
    *   A line separating **Granular** and **Infragranular** layers.

### 3. Labels, Keys & Legends
*   **Panel Titles:** The panels are labeled: **A AC anesthetized rat**, **B AC anesthetized mouse**, and **C AC awake mouse**.
*   **Legend:** A small legend is present in Panel A indicating:
    *   Gray shading/bar = Sample
    *   Burgundy shading/bar = Omission-sensitive
*   **Axis Labels:**
    *   Y-axis label: **Depth ($\mu$m)**
    *   X-axis label (implied): **Neurons**

### 4. Data Trends & Details
The data is segmented into three anatomical regions defined by the dashed lines: Supragranular, Granular, and Infragranular.

**Panel A (Anesthetized Rat):**
*   The depth ranges are marked, with the total AC thickness implied to be 1200 $\mu$m based on the caption.
*   The bars show a distribution across depths, with noticeable counts in the Supragranular, Granular, and Infragranular regions.
*   The caption notes that the fraction of omission-sensitive neurons (burgundy bars) relative to the total sample (gray bars) is low in supragranular layers.

**Panel B (Anesthetized Mouse):**
*   The depth ranges are marked, with the total AC thickness implied to be 1400 $\mu$m based on the caption.
*   The distribution shows counts across all three layers.

**Panel C (Awake Mouse):**
*   This panel shows the distribution for the awake mouse.
*   The caption highlights a trend: "for awake mice, there is a tendency toward a higher proportion of omission-sensitive neurons in the supragranular layers." This is visually supported by comparing the relative height of the burgundy bars to the gray bars in Panel C's supragranular region versus Panels A and B.

### 5. Contextual Caption Integration
The caption provides critical context for interpreting the visual elements:
*   **Layer Definitions:** The horizontal dashed lines delineate the **supragranular**, **granular**, and **infragranular** layers.
*   **Thickness Discrepancy:** The caption explains the difference in total AC thickness: 1400 $\mu$m for mice (due to oblique electrode trajectory) versus 1200 $\mu$m for the rat (due to orthogonal trajectory).
*   **Key Finding:** The figure visually supports the observation that while omission-sensitive neurons are present across layers, their relative proportion is notably higher in the supragranular layers of awake mice compared to anesthetized rats.
...
[e.g., (50–52)], as well as in the somatosensory system (53). In the
...
the omission responses were found to be larger in awake mice than
...
than the tone they replaced as occurring in many of our responses; if
...
Another interesting, yet difficult, issue to resolve is how the dif-
...
custom-written MATLAB GUI (Controller). Sounds were presented
...
Anesthesia was induced and maintained with urethane [1.9 g/kg,
...
Surgical procedures for IC (anesthetized rats)
...
by another dose of carprofen at the start of the surgery (5 mg/kg, sc).
In the anesthetized mice, the electrode array was inserted acutely for
...
session was 0.71 after spike-sorting, which is a typical yield, e.g., in
...
of SOA, respectively. Note that stimulus here refers to both tone and
