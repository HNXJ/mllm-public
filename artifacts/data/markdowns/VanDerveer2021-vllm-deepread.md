...
Schizophrenia Bulletin vol. 47 no. 5 pp. 1385–1398, 2021 
doi:10.1093/schbul/sbaa184
Advance Access publication December 28, 2020
...
A Role for Somatostatin-Positive Interneurons in Neuro-Oscillatory and 
Information Processing Deficits in Schizophrenia

Alice B. Van Derveer1, Georgia Bastos1,2, Antanovia D. Ferrell1, Connor G. Gallimore1, Michelle L. Greene1,  
Jacob T.  Holmes1, Vivien Kubricka1, Jordan M. Ross1,3, and Jordan P. Hamm*,1–3,

1Neuroscience Institute, Georgia State University, Petit Science Center, 100 Piedmont Ave, Atlanta, GA 30303; 2Center for 
Neuroinflammation and Cardiometabolic Diseases, Georgia State University, Petit Science Center, 100 Piedmont Ave, Atlanta, GA 
30303; 3Center for Behavioral Neuroscience, Georgia State University, Petit Science Center, 100 Piedmont Ave, Atlanta, GA 30303

*To whom correspondence should be addressed; tel: 404-413-5398, fax: 404-413-5446; e-mail: jhamm1@gsu.edu

Alterations in neocortical GABAergic interneurons (INs) 
...
Downloaded from https://academic.oup.com/schizophreniabulletin/article/47/5/1385/6054297 by Vanderbilt University Library user on 09 February 2026
...
A. B. Van Derveer et al

growing body of work concerning the function of somat-
...
> Figure caption (from PDF text): Fig. 1.  Three major neocortical interneuron categories. Interneuron groups are depicted, with subtypes and their laminar (middle) and 
major postsynaptic cellular (eg, pyramidal neurons) and subcellular (eg, dendrites) targets are graphically depicted (left and right).
> Figure description (generated): ## Figure Description: Three Major Neocortical Interneuron Categories

This figure presents a schematic diagram illustrating three major categories of neocortical interneurons, detailing their laminar distribution and connectivity targets. The overall layout is divided into a central columnar structure representing cortical layers, flanked by detailed representations of the interneuron subtypes and their targets.

### 1. Overall Layout & Structure

The figure is structured around a central vertical axis representing cortical layers (L1 through L6). To the left of this layer structure, there is a detailed schematic illustrating "Somatostatin-positive" interneurons. To the right, two distinct schematics illustrate "5HT3a-positive" and "Parvalbumin-positive" interneurons. A separate, dashed box at the bottom right highlights "long-range projection neurons."

### 2. Visual Components & Symbols

**A. Cortical Layer Column (Center):**
*   The central column is segmented into horizontal bands labeled with cortical layers: **L1, L2/3, L4, L5, and L6**.
*   Vertical lines connect the interneuron schematics (left/right) to specific layers, indicating laminar location.

**B. Somatostatin-positive Interneurons (Left Side):**
*   This section is titled **"Somatostatin-positive."**
*   It features schematic drawings of neurons (dendritic trees) representing different subtypes.
    *   The top drawing, labeled **"Martinotti-type,"** shows a neuron with extensive dendritic arborization.
    *   Below this, there is a schematic labeled **"X94,"** showing another neuronal morphology.
*   These schematics are connected to the central layer column via vertical lines, with specific points on the neurons corresponding to laminar locations.

**C. 5HT3a-positive Interneurons (Upper Right):**
*   This section is titled **"5HT3a-positive."**
*   It displays two distinct neuronal morphologies:
    *   One labeled **"L1 Neurogliaform,"** depicted with a sparse dendritic structure.
    *   Another schematic showing a neuron that appears to be targeting pyramidal neurons (implied by the context).
*   These are connected to the central layer column.

**D. Parvalbumin-positive Interneurons (Lower Right):**
*   This section is titled **"Parvalbumin-positive."**
*   It shows two distinct morphologies:
    *   One labeled **"Basket,"** characterized by a specific dendritic shape.
    *   Another labeled **"Chandelier,"** showing a distinct, compact morphology.
*   These are also connected to the central layer column.

**E. Connectivity and Targets:**
*   The schematics on the left and right show dendritic trees, representing the interneurons. The connections to pyramidal neurons (implied targets) are shown schematically within the context of the layers, though specific synaptic connections are not explicitly drawn as arrows between interneurons and pyramidal cells in this view.
*   The layer column itself acts as a map, showing where the different interneuron types are located.

**F. Long-Range Projection Neurons (Bottom):**
*   A separate, dashed box at the bottom right contains a schematic labeled **"long-range projection neurons,"** depicted with extensive, long axonal projections.

### 3. Labels and Annotations

*   **Titles/Categories:** "Somatostatin-positive," "5HT3a-positive," and "Parvalbumin-positive."
*   **Laminar Labels:** L1, L2/3, L4, L5, L6.
*   **Cell Type Labels:** "Martinotti-type," "X94," "L1 Neurogliaform," "Basket," and "Chandelier."
*   **Molecular Markers:** Somatostatin, 5HT3a, Parvalbumin.
*   **Other Labels:** "VIP" (visible near the 5HT3a schematic), and "long-range projection neurons."

### 4. Contextual Caption Integration (Interpretation)

The caption states that the figure depicts "Three major neocortical interneuron categories."
*   The left side represents one category (Somatostatin-positive).
*   The right side displays two other categories (5HT3a-positive and Parvalbumin-positive).
*   The schematic representations illustrate the "subtypes" (e.g., Martinotti-type, Basket) and their laminar locations within the neocortex layers (L1–L6).
*   The overall structure implies that the dendritic trees shown are targets or representations of these interneurons' connectivity patterns relative to cortical layers and major postsynaptic cells (like pyramidal neurons, which are implied targets).
...
> Figure caption (from PDF text): Fig. 2.  Martinotti-type somatostatin-positive (SST) interneurons in cortical circuits. Left: Cortical-column schematic depicting known 
roles of SSTs in dendritic inhibition and integration of top-down feedback (top) and disynaptic inhibition between pyramidal neurons 
(PYRs; triangles). Top-right: Hypothetical computational, circuit, and physiological signatures of layers 2/3 and 5 Martinotti SSTs. 
A theoretical set neuron-type raster plots and local field potential (LFP) recording is drawn from the hypotheses of this paper. Bottom-
right: Noninvasive biomarkers hypothetically related to Martinotti SST motifs.
...
This figure, titled "Fig. 2," presents a multi-part schematic illustrating the roles of Martinotti-type somatostatin-positive (SST) interneurons within cortical circuits, integrating circuit mechanisms with computational and physiological hypotheses. The figure is structured into several interconnected conceptual domains: a cortical column schematic on the left, and computational/physiological block diagrams on the right.

### 1. Overall Layout & Structure

The figure is divided into three main conceptual areas:
*   **Left Panel (Cortical Column Schematic):** A vertical schematic representing cortical layers (L1 through L6) showing dendritic inhibition and feedback loops.
*   **Top-Right Panel (Computational/Circuitry):** A block diagram detailing the hypothesized functions of Martinotti SSTs in layers 2/3 and 5.
*   **Bottom-Right Panel (Physiology & Biomarkers):** A section showing the hypothesized physiological signatures and associated noninvasive biomarkers.

### 2. Visual Components & Symbols

#### A. Cortical Column Schematic (Left Side)
This schematic depicts a vertical cross-section of the cortex, segmented into layers: L1, L2/3, L4, L5, and L6.

*   **Pyramidal Neurons (PYR):** Represented by upward-pointing triangles ($\triangle$). These are shown in layers L2/3 and L5.
*   **SST Interneurons:** Represented by circles ($\bullet$) located in layers L2/3 and L5.
*   **Dendritic Inhibition:** Indicated by lines connecting SSTs to PYRs, suggesting inhibitory input.
*   **Feedback Loops:** Arrows illustrate functional connections:
    *   A green arrow labeled "cortico-cortical feedback" originates from the upper layers and loops back down.
    *   A blue arrow labeled "L1 input gating" points into the upper layers.
    *   An arrow originating from L5 SSTs and pointing towards PYRs in L2/3 suggests a specific inhibitory pathway.
    *   A downward arrow labeled "disynaptic inhibition" connects L5 PYRs to L2/3 PYRs, mediated by SSTs.

#### B. Computational and Circuitry Block Diagram (Top-Right)
This section uses interconnected boxes to represent functional modules:

*   **Input/Processing Blocks:** Boxes are connected by arrows indicating information flow.
    *   A box labeled "computation" contains sub-functions: "-context processing," "-spatiotemporal integration," and "-working memory."
    *   A box labeled "circuitry" is connected to the computation block.
*   **SST Layer Specificity:** Two distinct nodes are shown:
    *   "Martinotti SSTs," with a sub-label indicating "lay 2/3."
    *   "Martinotti SSTs," with a sub-label indicating "lay 5."
*   **Flow:** Arrows show that the SSTs feed into and interact with the computational modules. The circuitry block is linked to a box labeled "feedback modulation" which, in turn, interacts with the SSTs.

#### C. Physiological and Biomarker Section (Bottom-Right)
This section illustrates the downstream consequences of the circuit activity:

*   **Physiology:** A box labeled "physiology" is connected to the computational/circuitry flow. This block points towards a representation of oscillatory activity:
    *   A waveform labeled "$\beta$" (Beta) is shown, representing oscillations.
    *   An arrow points from this oscillation representation to a box labeled "LFP" (Local Field Potential).
    *   A dashed line indicates the relationship between LFP and "feedback input."
    *   The time scale is noted as "$100\text{ms}$".
*   **Biomarkers:** A final section shows a stylized brain region (likely representing cortical activity) with colored heat map-like patterns, labeled "SZ- biomarkers." This section lists specific hypothesized phenomena: "-contour integration," "-oddball," and "-illusion susceptibility -gestalt."

### 3. Labels, Keys & Legends

**Key Components and Annotations:**
*   **Layers:** L1, L2/3, L4, L5, L6.
*   **Cell Types:** PYR (Pyramidal Neuron), SST (Somatostatin-positive interneuron).
*   **Functional Labels:** "cortico-cortical feedback," "L1 input gating," "disynaptic inhibition."
*   **Computational Labels:** "-context processing," "-spatiotemporal integration," "-working memory."
*   **Physiological Labels:** "physiology," "$\beta$ LFP," "feedback input."
*   **Biomarker Labels:** "SZ- biomarkers," "-contour integration," "-oddball," "-illusion susceptibility -gestalt."

### 4. Data Trends & Details (Plots)
The figure does not contain traditional quantitative graphs with labeled axes for data trends. The representation of $\beta$ oscillations is a schematic waveform, not a plotted time-series graph.

### 5. Contextual Caption Integration
The caption clarifies the roles:
*   **Left Schematic:** Depicts "known roles of SSTs in dendritic inhibition and integration of top-down feedback (top) and disynaptic inhibition between pyramidal neurons (PYRs; triangles)."
*   **Top-Right Block Diagram:** Represents the "Hypothetical computational, circuit, and physiological signatures of layers 2/3 and 5 Martinotti SSTs."
*   **Bottom-Right Section:** Shows a "theoretical set neuron-type raster plots and local field potential (LFP) recording is drawn from the hypotheses of this paper," leading to "Noninvasive biomarkers hypothetically related to Martinotti SST motifs."
...
cells. Martinotti neurons in L5 also subserve disynapatic 
...
> Figure caption (from PDF text): Fig. 3.  Layer 4 X94 somatostatin-positive (SST) interneurons in cortical circuits. Left: Cortical-column schematic depicting known 
roles of SSTs (ovals) in inhibiting parvalbumin-positive (PV) interneurons (circles) to effectively disinhibit feedforward inputs of layer 4 
excitatory cells (diamonds) to layer 2/3 pyramidal neurons (triangles). Top-right: Hypothetical computational, circuit, and physiological 
signatures of layer 4 X94-SSTs. A theoretical set neuron-type raster plots and local field potential recording is drawn from the hypotheses 
of this paper. Bottom-right: Noninvasive biomarkers hypothetically related to X94 SST-motifs.
...
This figure, titled "Fig. 3," presents a multi-part schematic illustrating the role of Layer 4 X94 somatostatin-positive (SST) interneurons within cortical circuits, alongside hypothetical computational, circuit, and physiological signatures.

### 1. Overall Layout & Structure
The figure is divided into three main conceptual areas: a neural circuit schematic on the left, a block diagram illustrating computational/circuit/physiological interactions in the upper right, and raster plots/biomarker representations in the lower right.

### 2. Visual Components & Symbols (Circuit Schematic - Left Side)
The left side depicts a schematic of cortical layers: L1, L2/3, and L4.

*   **Layers:** Horizontal lines delineate the cortical layers: L1 (top), L2/3 (middle), and L4 (bottom).
*   **Cell Types:** Various geometric shapes represent different neuronal populations:
    *   **Triangles ($\triangle$):** Represent pyramidal neurons, specifically shown in L2/3.
    *   **Diamonds ($\diamond$):** Represent excitatory cells, shown in L4.
    *   **Circles ($\circ$):** Represent Parvalbumin-positive (PV) interneurons.
    *   **Ovals ($\text{oval}$):** Represent Somatostatin-positive (SST) interneurons.
*   **Connections:** Lines and arrows indicate synaptic connectivity between layers and cell types. The schematic shows inputs targeting L4 excitatory cells ($\diamond$), which then project to L2/3 pyramidal neurons ($\triangle$). The SSTs (ovals) are shown inhibiting PV interneurons (circles).

### 3. Visual Components & Symbols (Computational/Circuit/Physiology - Upper Right)
This section is a flow diagram connecting abstract concepts:

*   **Boxes:** Three main conceptual boxes are present:
    1.  "computation": Contains sub-bullets listing functions: "-feedforward facilitation," "-visuospatial attention," and "-working memory."
    2.  "circuitry": Contains the label "disinhibition."
    3.  "physiology": Contains the label "-theta/alpha osc.-cross-freq. coupling (CFC)."
*   **Nodes:** A specific node labeled "X94 SSTs" acts as a central hub, connecting the three conceptual boxes.
*   **Arrows:** Arrows indicate directional flow:
    *   An arrow points from "computation" towards "X94 SSTs."
    *   Arrows flow between the three main boxes, indicating interactions (e.g., from "circuitry" to "physiology," and back).
    *   A prominent arrow points from the "circuitry" box towards the "X94 SSTs" node, labeled with an arrow pointing *out* of the box.

### 4. Visual Components & Symbols (Lower Right - Plots and Biomarkers)
This area contains raster plots, LFP traces, and a biomarker visualization.

*   **Raster Plots:** Two sets of raster plots are shown:
    *   One set is labeled "PVs" and shows discrete vertical lines (spikes) over a time axis.
    *   The second set is labeled "SSTs" and shows similar spike patterns.
    *   A third, smaller set is labeled "lay 4 exc." showing spiking activity.
    *   A time scale bar indicates **"100ms"** below the plots.
*   **LFP Trace:** A waveform labeled "LFP" is shown above the raster plots, depicting oscillating activity.
*   **Biomarker Visualization:** A small diagram in the bottom right shows a stylized representation of a head/brain area, overlaid with color gradients (red and blue), associated with the label **"SZ- biomarkers paradigms:"**.
    *   This section lists specific cognitive tasks: "-P50 gating," "-visual search," and "-d-span."

### 5. Labels, Keys & Legends
*   **Layer Annotations:** L1, L2/3, and L4 are explicitly labeled on the left schematic.
*   **Cell Type Labels:** PVs, SSTs, and L4 exc. are used in the lower right plots.
*   **Key Annotations:** The caption identifies:
    *   Ovals as SSTs.
    *   Circles as PVs.
    *   Diamonds ($\diamond$) as L4 excitatory cells.
    *   Triangles ($\triangle$) as L2/3 pyramidal neurons.
*   **Computational Labels:** "feedforward facilitation," "visuospatial attention," and "working memory" are listed under computation.
*   **Circuitry Label:** The term **"disinhibition"** is central to the circuitry box.

### 6. Contextual Caption Integration
The caption clarifies that:
*   The left schematic depicts the role of **Layer 4 X94 SSTs (ovals)** in inhibiting **PV interneurons (circles)**.
*   This inhibition leads to the effective **disinhibition** of **feedforward inputs** targeting **Layer 4 excitatory cells (diamonds)**, which subsequently drive **Layer 2/3 pyramidal neurons (triangles)**.
*   The upper right section represents the **hypothetical computational, circuit, and physiological signatures** of these X94 SSTs.
*   The lower right section illustrates a **theoretical set neuron-type raster plot** and an **LFP recording**, alongside **noninvasive biomarkers** related to X94 SST-motifs.
...
suggest that SSTs are affected in people with SZ (table 1; 
...
DLPFC, orbitofrontal cortex
PV and calretinin (no 
...
IN subtype, 5HT3a-containing, has not been studied in 
...
In contrast, PV inhibition targets dendritic and so-
...
Low-Frequency Oscillations Mark Information 
...
Mental Health (F32MH125445 to J.M.R.; R00MH115082 
to J.P.H.) and the Whitehall Foundation (2019-05-44 to 
J.P.H.).