...
\textbf{Supplementary Table S5:} 31-Paper Literature Corpus Registry with modality, inclusion basis, and provenance.
...
Leave-One-Model-Out (LOMO) & 10 folds & $\Delta_{\text{Total}} \in [-0.105, -0.093]$ & Negative throughout & H2 $\Delta \in [-0.228, -0.208]$ \\
\end{longtable}
...
\textbf{Supplementary Table S13:} Manual Expert Validation Summary of Generated Multimodal Figure Descriptions ($N=10$ prespecified figures audited against primary-source PDFs).
